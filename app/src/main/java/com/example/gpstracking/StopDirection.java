...
public class StopDirection extends FragmentActivity implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(activity_stop_direction);
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(StopDirection.this, MapsActivity.class));
            }
        });
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(@NonNull Location location) {
               ...
               double convertm = distance / 1000;
                ...
                new FetchURL(StopDirection.this).execute(getUrl(place1.getPosition(), place2.getPosition(), "driving"), "driving");
