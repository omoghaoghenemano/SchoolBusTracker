 ...
 */
public class RoutesMenu extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String ma = "Near by";
        String mas ="All Routes";
        mas.toLowerCase(Locale.ROOT);



        adapter.AddFragments(new NearbyRoute(),  ma);
        adapter.AddFragments(new RouteFragment(), mas);
