 ...
 * Use the {@link BusMenu#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BusMenu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bus_menu, container, false);
        ...
        String ma = "Near by";
        String mas ="All Buses";
        mas.toLowerCase(Locale.ROOT);

        adapter.AddFragments(new NearbyBuses(),  ma);
        adapter.AddFragments(new Buses(), mas);
